...
#
# Generated by Vivado on Fri May 19 21:59:29 EEST 2023
...
#    "/home/willow/prj/fpga-other/projf-explore/cpu/mk14/disp_kbd.mem"
...
#    "/home/willow/prj/fpga-other/projf-explore/cpu/mk14/xc7/top_mk14_tb_behav.wcfg"
#
#*****************************************************************************************
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../disp_kbd.mem"] \
...
set file "$origin_dir/../../disp_kbd.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../top_mk14_tb_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files

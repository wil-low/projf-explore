...
if {[is_project_open]} {
	if {[string compare $quartus(project) "cpu7"]} {
		puts "Project cpu7 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists cpu7]} {
		project_open -revision top cpu7
	} else {
		project_new -revision top cpu7
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY top_cpu7
	...
	set_global_assignment -name SYSTEMVERILOG_FILE ../top_cpu7.sv
